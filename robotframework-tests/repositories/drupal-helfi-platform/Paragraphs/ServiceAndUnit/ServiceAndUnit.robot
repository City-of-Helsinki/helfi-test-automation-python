...
Banner Paragraph Should Have Selected Color
	...
	Run Keyword If   not(${CI})   Capture Element Screenshot  css:div.unit-header__container.container > div.unit__header > div.enriched-content.has-sidebar   filename=${REPORTS_PATH}/${BROWSER}_TESTRUN-${SUITE}-${TEST NAME}_${language}.png
